    ...
    <div class="min-h-full">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
              <div class="shrink-0">
                <img class="size-8" src="../assets/mic.jpg" alt="Your Company" />
              </div>
                ...
                <Menu as="div" class="relative ml-3">
                  <div>
                    <MenuButton class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
                      ...
                      <span class="text-white bg-black pt-2 pl-2 pr-2 pb-2">{{user.name}}</span>
                    </MenuButton>
                  </div>
        ...
        <DisclosurePanel class="md:hidden">
          ...
          <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="mt-3 space-y-1 px-2">
              <button @click="logout" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign Out</button>
            </div>
          </div>
        </DisclosurePanel>
      </Disclosure>
      ...
      <header class="bg-white shadow-sm">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-gray-900">AI Generated 5 Songs Playlist App</h1>
        </div>
      </header>
      <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
